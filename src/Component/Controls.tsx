...
export default function Controls(props: ControlsProps) {
    ...
    function handleChange(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        if (isNaN(newValue as any) && newValue !== '-') return

        if (newValue !== '-') props.changeTimer(newValue.toString())
    }
    ...
    const hideButton = !(props.filename && props.timerValue != '' && parseFloat(props.timerValue)) ? ' hide-button' : ''
        ...
        <div className="controls">
            <div className="controls-generate">
                <div className="timer-buttons">
                    ...
                    <button id="plus" className="blue-button" onClick={() => updateTimer(1)} title={'+' + updateStep * 1000 + 'ms'}>
                        +
                    </button>
                    <button id="minus" className="blue-button" onClick={() => updateTimer(-1)} title={'-' + updateStep * 1000 + 'ms'}>
                        -
                    </button>
                </div>
