/*! For license information please see main.2a3fd28e.js.LICENSE.txt */
!(function () {
    "use strict";
    var e = {
            463: function (e, n, t) {
                ...
                function Ae(e, n, t, r, l, a, o, u, i) {
                    (je = !1), (De = null), Fe.apply(Ve, arguments);
                }
                function $e(e) {
                    var n = e,
                        t = e;
                ...
                function Kn(e, n, t, r) {
                    if (Hn) {
                        var l = Zn(e, n, t, r);
                        if (null === l) Qr(e, n, r, Yn, t), jn(e, r);
                        else if (
                            (function (e, n, t, r, l) {
                                switch (n) {
                                    case "focusin":
                ...
                function Qa(e, n, t, r) {
                    (e = n.state),
                        ...
                        n.state !== e &&
                            Aa.enqueueReplaceState(n, n.state, null);
                }
                function Ha(e, n, t, r) {
                    var l = e.stateNode;
                    (l.props = t),
                ...
                function ku(e, n, t, r) {
                    n.child =
                        null === e ? Xa(n, null, t, r) : Za(n, e.child, t, r);
                }
                ...
                function qu(e, n, t) {
                    ...
                    switch ((na(n), n.tag)) {
                        ...
                        case 10:
                            return Sa(n.type._context), Wu(n), null;
                        case 19:
                ...
                function is(e) {
                    ...
                    if (1 === t)
                        throw ((t = Fi), ds(e, 0), us(e, n), rs(e, Xe()), t);
    ...
    !(function () {
        ...
        function h(n) {
            var t = n.children,
                r = l(e.useState({ type: "", text: "", visible: !1 }), 2),
                o = r[0],
                u = r[1];
            ...
            function i() {
                u(f(f({}, o), {}, { visible: !1 })), clearTimeout(d);
            }
        }
        var m = 0.25;
        function v(n) {
            var t = e.useContext(p).open;
            function r(e) {
                var t = m * e;
                n.changeTimer((parseFloat(n.timerValue) + t).toFixed(3));
            }
            var l =
                n.filename && "" != n.timerValue && parseFloat(n.timerValue)
                    ? ""
                    : " hide-button";
            return (0, a.jsx)("div", {
                className: "controls",
                children: (0, a.jsxs)("div", {
                    className: "controls-generate",
                    children: [
                        (0, a.jsxs)("div", {
                            className: "timer-buttons",
                            children: [
                                (0, a.jsxs)("div", {
                                    id: "change-input-wrapper",
                                    children: [
                                        (0, a.jsx)("input", {
                                            id: "change-input",
                                            onChange: function (e) {
                        ...
                        n.lastLink &&
                            ...
                            (0, a.jsx)("button", {
                                className: "blue-button",
                                onClick: function () {
                                    navigator.clipboard.writeText(n.lastLink),
                                        t({
                                            type: "success",
        ...
        var y = /\d\d:\d\d:\d\d,\d\d\d\s+-->\s+\d\d:\d\d:\d\d,\d\d\d/;
        function b(n) {
            var t = l(e.useState(!1), 2),
                r = t[0],
                o = t[1],
                u = e.useRef(null),
                i = e.useContext(p).open;
            function s(e) {
                c(e),
                    o(!1),
                    (function (e) {
            ...
            function f(e) {
                if (e.size > 104857600)
                    i({ type: "error", text: "Wrong file format" });
                else {
                    ...
                    t.addEventListener("load", function (t) {
                        ...
                        !(function (e) {
                            ...
                            ? i({ type: "error", text: "Wrong file format" })
                            : n.onFileChange(e.name, l);
                    }),
                        t.readAsText(e);
                }
            }
            var d = n.loading ? "disabled" : "",
                h = r ? "dragging" : "";
            return (0, a.jsxs)("div", {
                className: "drop " + d + h,
        ...
        function k(e) {
            return (0, a.jsx)("div", {
                className: "preview" + (e.previewText ? " show-preview" : ""),
                children: (0, a.jsx)("pre", {
                    className: "preview-text",
                    children: e.previewText,
                }),
            });
        }
        var S = "App-dark.css",
            x = "App-light.css",
            E = document.querySelector("#ThemeCss");
        function C() {
            var n = l(e.useState(x), 2),
                t = n[0],
                r = n[1];
            function o() {
                r(t == x ? S : x);
        ...
        var P = 1e3,
            z = /(\d\d:\d\d:\d\d,\d\d\d)\s+-->\s+(\d\d:\d\d:\d\d,\d\d\d)/g,
            T = "https://ten-responsible-bayberry.glitch.me";
        function L() {
            var n = l(e.useState(""), 2),
                t = n[0],
                r = n[1],
                o = l(e.useState(""), 2),
                u = o[0],
                i = o[1],
                s = l(e.useState("0.000"), 2),
                c = s[0],
                f = s[1],
                d = l(e.useState({ lastTime: "", lastLink: "" }), 2),
                h = d[0],
                m = d[1],
                g = l(e.useState(!1), 2),
                y = g[0],
                S = g[1],
                x = e.useRef(""),
                E = e.useContext(p).open;
            function N() {
                if (x.current) {
                    var e = (function (e, n, t) {
                        var r;
                        do {
                            if (-1 == (r = e.indexOf(n, r))) return -1;
                            if (0 == --t) return r;
                            r++;
                        } while (t);
                        return r;
                    ...
                    if (-1 != e) {
                        var n = parseFloat(c) * P,
                            t = x.current.slice(0, e);
                        (t = t.replaceAll(z, function (e, t, r) {
                            return R(O(t) + n) + " --\x3e " + R(O(r) + n);
                        })),
                            i(t);
                    }
                }
            ...
            return (
                e.useEffect(function () {
                    window.location.search.match(/\?id=/) &&
                        fetch(T + "/download" + window.location.search, {
                            method: "POST",
                        })
                            .then(function (e) {
                                return e.text();
                ...
                (0, a.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, a.jsx)(v, {
                            ...
                            lastLink: c == h.lastTime ? h.lastLink : "",
                            loading: y,
                        }),
                        (0, a.jsx)(k, { previewText: u }),
                        (0, a.jsx)(_, {}),
                    ],
                })
            );
        ...
        n.createRoot(document.getElementById("root")).render(
            (0, a.jsx)(e.StrictMode, {
                children: (0, a.jsx)(h, { children: (0, a.jsx)(L, {}) }),
            }),
        );
    })();
})();
//# sourceMappingURL=main.2a3fd28e.js.map
